...
//		On construit le chapeau à partir des points
...
//		Constructeur par copie du chapeau à partir d'une forme Chapeau

	
	public Chapeau(String nom, Forme f) throws ClassCastException {
		
//		Le try-catch sert à vérifier si la forme à copier est bien un chapeau
...
// 		Exceptions:
//			IndexOutOfBoundsException si l'indice i est en dehors de la liste des PointPlans de la classe Chapeau
...
//		Retourne la liste des points du chapeau (Cette méthode est privée car l'utilisateur de la classe Chapeau n'aura pas besoin de cette méthode qui est juste une question de simplicité pour les développeurs de la classe)
...
//		Retourne une liste des segments qui dessinent le chapeau
...
//		Initialiser un chapeau avec le clavier
